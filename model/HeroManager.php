...
class HeroManager
{
    ...
    /**
     * Returns the hero template (stats at the begining of the game)
     * @param $id
     * @return mixed
     */
    ...
    public function heroDataGame($id)
    {
        ...
        // (return new Hero($dataHero[0]); c'est bien aussi :p)
    }
    ...
    /**
     * returns an array of Cards (obj) that represents the deck of the hero
     * @param int $idHero
     * @return array
     */
    ...
    //        DBManager::getInstance()->getPdo()->query('CREATE TABLE card_game1 LIKE card_template');
        ...
        DBManager::getInstance()->getPdo()->query('INSERT INTO card_game1 SELECT * FROM card_template'); // vous etiez fatigué là?
